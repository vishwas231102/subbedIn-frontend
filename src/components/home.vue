<template>
  <div class="container">
    <div id="theme">
      ...
      <p class="text" style="font-style: italic;font-weight: bold;font-size: clamp(0.85em,2vw,5em);margin-top: 2.5vh;margin-bottom: 5vh;opacity: 0.85;text-align: center;">You've spent enough time on the bench, get SubbedIn now!</p>
    </div>
