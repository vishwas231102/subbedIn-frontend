  ...
  <div class="container">
    <div id="theme">
      <h1 class="header" style="font-size: clamp(3.5em,10vw,10em);opacity: 0.85;margin-top: 1vh;margin-bottom: 1vh;">SubbedIn</h1>
        <p class="text" style="font-style: italic;font-weight: bold;font-size: clamp(0.95em,2vw,5em);opacity: 0.85;text-align: center;margin: 0%;">You've spent enough time on the bench,</p>
        <p class="text" style="font-style: italic;font-weight: bold;font-size: clamp(0.95em,2vw,5em);opacity: 0.85;text-align: center;margin: 0%;">get SubbedIn now!</p>
    </div>
    ...
    <span id="footer" class="text" style="font-size: clamp(0.55em,1.25vw,2em);font-weight: bold;">Got a question ? We are just an email away :<span style="color: rgb(0, 102, 204);"> contact@subbedin.com </span></span>
  </div>
</template>
