<template>
  <div class="container">
    ...
    <span id="footer" class="text" style="font-size: clamp(0.55em,1.25vw,2em);font-weight: bold;">Got a question ? We are just an email away :<a href="mailto:contact@subbedin.com" style="color: rgb(5, 70, 140);"> contact@subbedin.com </a></span>
  </div>
</template>
